...
public class ClientImpl implements IClient{
    ...
    public int menu() {
        ...
        System.out.println("--------------GESTION MAILING--------------");
    ...
    public void creation(Client client) {
        ...
        try {
            ...
            Object [] par = {client.getNom(),client.getPrennom(),client.getEmail(),client.getTel()};
    ...
    public void affichage(Client client) {
        ...
        System.out.println(" nom : "+client.getPrennom());
    ...
    public void edition(Client client) {
        ...
        try {
            bd.myPrepareStatement(sql);
            Object [] par = {client.getNom(),client.getPrennom(),client.getEmail(),client.getTel(),client.getId()};
            bd.addParameters(par);
